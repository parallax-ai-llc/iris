...
`iris-templates` (and the other fair-code Iris packages) is **source-available**
...
For uses beyond what this license permits (for example, offering iris-templates to
