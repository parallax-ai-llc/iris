...
import type { ChatMessage } from '@/features/image-editor/stores/editorChat.store';
...
function CommandStatus({ message }: { message: ChatMessage }) {
    ...
    return (
      <div className="flex-1 flex items-center justify-center px-4">
        <p className="text-xs text-zinc-500 text-center leading-relaxed">
          Ask AI to help edit your image.<br />
          Try: "Generate a cat illustration" or "Remove background"
        </p>
      </div>
    );
  }
